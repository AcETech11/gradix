...
export function ParentPortalEmptyState({ description, title }: ParentPortalEmptyStateProps) {
  return (
    <section className="w-full max-w-xl rounded-[1.75rem] border border-slate-200 bg-white p-6 text-center shadow-[0_30px_80px_-45px_rgba(15,23,42,0.35)]">
      ...
      <Link className="mt-6 inline-flex h-11 items-center justify-center rounded-2xl bg-slate-950 px-5 text-sm font-semibold text-white" href="/results">
        Try another code
      </Link>
    </section>
  );
